							...
							<div class="table-container">
								...
								<c:forEach items="${productList}" var="p" varStatus="STT">		
									<tr role="row" class="filter">
										...
										<td>${p.name }</td>
										<td>${p.price }000 đ</td>
										<c:url value="/productImage?fname=${p.image }" var="imgUrl"></c:url>
										...
										<td>
											<div class="margin-bottom-5">
												<a href="${pageContext.request.contextPath}/seller_products_add?pid=${p.id }" role="button" class="btn btn-sm yellow filter-submit margin-bottom"><i class="fa fa-edit"></i> Edit</a>
											</div>
											<a href="${pageContext.request.contextPath}/seller_products_delete?pid=${p.id }" role="button" class="btn btn-sm red filter-cancel"><i class="fa fa-trash"></i> Delete</a>
										</td>
									</tr>
								</c:forEach>
								</tbody>
