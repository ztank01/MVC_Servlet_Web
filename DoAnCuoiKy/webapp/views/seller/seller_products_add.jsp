		...
		<div class="row">
			<div class="col-md-12">
				<form class="form-horizontal form-row-seperated"
					action="api/add_edit_product" method="post" enctype="multipart/form-data">
					<div class="portlet">
						<div class="portlet-title">
							...
							<div class="actions btn-set">
								<a href="${pageContext.request.contextPath}/seller_products"
									role="button" class="btn default"><i
								...
								<div class="tab-content no-space">
									<div class="tab-pane active" id="tab_general">
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<textarea class="form-control" name="description"
													style="height: 300px;">${product.description }</textarea>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<select class="col-md-10 form-control" name="category">
													<c:forEach items="${categories}" var="c" varStatus="STT">
														<c:choose>
															<c:when test="${product.categoryID == c.cate_id }">
																<option selected="selected" value="${c.cate_id }" label="${c.cname}">${c.cname}</option>
															</c:when>
															<c:otherwise>
																<option value="${c.cate_id }" label="${c.cname}">${c.cname}</option>
															</c:otherwise>
														</c:choose>
													</c:forEach>
												</select>
										...
										<div class="form-group">
											<label class="col-md-2 control-label">In Stock: <span
												class="required"> * </span>
											</label>
											<div class="col-md-10">
