				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							...
							<span class="label label-info">Status = 0: Waiting Confirm</span>
							<span class="label label-success">Status = 1: Confirm</span>
							<span class="label label-danger">Status = 2: Cancel</span>
							...
							<div class="table-container">
								...
								<tbody>
									...
									<tr role="row" class="filter">
										...
										<td>${o.productId }</td>
										<td>${o.quantity }</td>
										<td>${o.unitPrice }000 đ</td>
										<td>${o.quantity * o.unitPrice }000 đ</td>
										<td>${o.status }</td>
										<td>
											<div class="margin-bottom-5">
												<a href="${pageContext.request.contextPath}/seller_orders_view?ItemId=${o.id }" role="button" class="btn btn-sm yellow filter-cancel"><i class="glyphicon glyphicon-eye-open"></i> View Detail</a>
											</div>
											<c:if test="${o.status  == 0}">
												<div class="margin-bottom-5">
													<a href="${pageContext.request.contextPath}/seller_orders_confirm?ItemId=${o.id }" role="button" class="btn btn-success filter-submit margin-bottom"><i class="glyphicon glyphicon-ok"></i> Confirm</a>
												</div>
												<div class="margin-bottom-5">
													<a href="${pageContext.request.contextPath}/seller_orders_cancel?ItemId=${o.id }" role="button" class="btn btn-sm red filter-cancel"><i class="glyphicon glyphicon-remove"></i> Cancel</a>
												</div>
											</c:if>
										</td>
										</tr>
