				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-shopping-cart"></i>Order #${item.id } <span class="hidden-480">
													...
													<div class="portlet-body">
														...
														<div class="row static-info">
															...
															<c:choose>
																...
																<c:otherwise>
																	<span class="label label-info">Waiting Confirm</span>
																</c:otherwise>
															</c:choose>
															</div>
														</div>
													...
													<div class="portlet-body">
														<div class="row static-info">
															<div class="col-md-12 value">
																Customer Name: ${customer.uname }<br>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="portlet blue-hoki box">
													...
													<div class="portlet-body">
														...
														<div class="row static-info">
															...
															<div class="col-md-7 value">
																<c:url value="/productImage?fname=${product.image }" var="imgUrl"></c:url>
											...
											<div class="col-md-6">
												<div class="well">
													...
													<div class="row static-info align-reverse">
														...
														<div class="col-md-3 value">
															  ${item.quantity} x  ${item.unitPrice}000 đ = ${item.quantity * item.unitPrice}000 đ
														</div>
													</div>
													<div class="row static-info align-reverse">
														<div class="col-md-8 name">
														...
														<div class="col-md-3 value">
															  ${item.quantity * item.unitPrice}000 đ
														</div>
													</div>
													<div class="row static-info align-reverse">
														<div class="col-md-8 name">
													...
													<c:if test="${item.status  == 0}">
														<div class="margin-bottom-5">
															<a href="${pageContext.request.contextPath}/seller_orders_confirm?ItemId=${item.id }" role="button" class="btn btn-success margin-bottom align-reverse"><i class="glyphicon glyphicon-ok"></i> Confirm</a>
														</div>
														<div class="margin-bottom-5">
															<a href="${pageContext.request.contextPath}/seller_orders_cancel?ItemId=${item.id }" role="button" class="btn btn-danger margin-bottom align-reverse"><i class="glyphicon glyphicon-remove"></i> Cancel</a>
														</div>
													</c:if>
												</div>
											</div>
