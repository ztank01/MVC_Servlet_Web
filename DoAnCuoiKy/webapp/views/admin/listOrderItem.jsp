			...
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu page-sidebar-menu-hover-submenu "
					...
					<li class="active open"><a href="javascript:;"> <i
							class="fa fa-truck"></i> <span class="title">Quản lý đơn hàng</span><span
							class="selected"></span> <span class="arrow open"></span>
					</a>
						<ul class="sub-menu">
							<li class="active"><a href="<c:url value='/admin/orderItem/list'/>"> <i
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<table class="table table-striped table-hover table-bordered" style="width:100%"
									...
									<tbody>
										<c:forEach items="${orderItemList}" var="orderItem" varStatus="STT">
											<tr class="odd gradeX">
												<td>${STT.index+1 }</td>
												...
												<td><a
													href="<c:url value='/admin/orderItem/delete?id=${orderItem.itemId }'/>"
