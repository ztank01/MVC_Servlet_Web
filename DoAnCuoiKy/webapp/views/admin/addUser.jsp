				...
				<ul class="page-sidebar-menu page-sidebar-menu-hover-submenu "
					...
					<li class="active open"><a href="javascript:;"> <i 
						...
						<ul class="sub-menu">
							...
							<li class="active"><a href="<c:url value='/admin/user/add'/>"> <i
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-edit"></i>Thêm tài khoản mới
								</div>
							</div>
								...
								<form role="form" action="add" method="post"
									...
									<div class="form-group">
										<label>Password:</label> <input  type="password" class="form-control"
											placeholder="please enter category Name" name="pass" />
									</div>
									<div class="form-group">
										<label>IsSeller:</label><br>Có <input type="radio" value="1" name="isSeller" />
											Không <input checked="checked" type="radio" value="0" name="isSeller" />
									</div>
									<div class="form-group">
										<label>IsAdmin:</label><br>Có <input type="radio" value="1" name="isAdmin" />
											Không <input checked="checked" type="radio" value="0" name="isAdmin" />
									</div>
