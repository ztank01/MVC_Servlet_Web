			...
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu page-sidebar-menu-hover-submenu "
					...
					<li class="active open"><a href="javascript:;"> <i
						...
						<ul class="sub-menu">
							<li class="active"><a href="<c:url value='/admin/product/list'/>"> <i
							...
							<div class="portlet-body">
								...
								<form role="form" action="${edit }" method="post"
									...
									<div class="form-group">
										<label>Tên sản phẩm:</label> <input value="${product.name }" class="form-control"
											placeholder="please enter category Name" name="name" />
									</div>
									<div class="form-group">
										<label>Mô tả:</label>
										<textarea name="editor">${product.description}</textarea>
										<script>
									...
									<div class="form-group">
										<label>Giá sản phẩm:</label> <input type="number"
											class="form-control" placeholder="please enter category Name" value="${product.price }"
											name="price" />
									</div>
									<div class="form-group">
										...
										<input value="${product.image }" type="file" name="icon" />
									</div>
									<div class="form-group">
										<label>Thuộc danh mục sản phẩm:</label> <select name="cate_id">
											<option value="${product.categoryID }"  selected="selected" hidden="hidden">${product.cate_name }</option>
									...
									<div class="form-group">
										<label>Người bán:</label> <select name="seller_id">
											<option value = "${product.sellerID }" selected="selected" hidden="hidden">${product.user }</option>
									...
									<div class="form-group">
										<label>Số lượng đã bán:</label> <input value="${product.amount }" type="number"
											class="form-control" placeholder="please enter category Name"
											name="amount" />
									</div>
									<div class="form-group">
										<label>Số lượng trong kho:</label> <input value="${product.inStock }" type="number"
											class="form-control" placeholder="please enter category Name"
											name="inStock" />
									</div>
